  ...
  return (
    ...
    >
      ...
      <div className="container relative px-4">
        ...
        <motion.div
          className="rounded-[36px] border border-emerald-200/80 bg-[linear-gradient(135deg,rgba(240,253,244,0.98),rgba(220,252,231,0.85)_55%,rgba(187,247,208,0.72))] p-6 shadow-[0_24px_90px_-55px_hsl(var(--foreground)/0.45)] sm:p-8"
        ...
        >
          <div className="grid gap-8 xl:grid-cols-[0.94fr_1.06fr]">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-emerald-950/72">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                {metrics.map((metric) => (
                  <div
                    key={metric.label}
                    className="rounded-3xl border border-emerald-200/80 bg-white/70 px-5 py-5 backdrop-blur"
                  >
                    <p className="text-sm uppercase tracking-[0.2em] text-emerald-900/55">
                      {metric.label}
                    </p>
                    <p className="font-heading mt-3 text-xl font-semibold text-emerald-950">
                      {metric.value}
                    </p>
                  </div>
                ))}
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-[30px] border border-emerald-200/80 bg-white/82 p-6 backdrop-blur">
              ...
              <div className="rounded-[30px] border border-emerald-300/70 bg-emerald-950 p-6 text-white shadow-lg">
              ...
              <div className="rounded-[30px] border border-emerald-200/80 bg-white/82 p-6 backdrop-blur lg:col-span-2">
